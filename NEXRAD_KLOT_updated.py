...
# --- SETTINGS ---
OUTPUT_FOLDER = '/Users/jnick/intercollegiate/radar_output_images'
...
if __name__ == '__main__':
    ...
    file_list = sorted(glob.glob('/Users/jnick/intercollegiate/nexrad_KLOT_2026-03-26/*'))
    ...
    if len(png_files) > 1:
        ...
        gif_path = os.path.join(OUTPUT_FOLDER, 'radar_loop.gif')
